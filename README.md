...
1. Gerar o APK:
   ...
   ```
2. Ao final, o EAS dá um **link/QR** — baixe o arquivo `.apk` por ali (esse link já é um instalador direto).
3. (Opcional) Suba o `.apk` no **MediaFire** e compartilhe o link com os testadores — é só um espelho do mesmo `.apk`.
